...
create table if not exists public.payroll_records (
  ...
  holiday_attendance_days numeric(8, 2) not null default 0,
  paid_leave_days numeric(8, 2) not null default 0,
  absence_days numeric(8, 2) not null default 0,
  late_early_count numeric(8, 2) not null default 0,
  scheduled_work_hours numeric(8, 2) not null default 0,
  overtime_work_hours numeric(8, 2) not null default 0,
  holiday_work_hours numeric(8, 2) not null default 0,
  late_night_hours numeric(8, 2) not null default 0,
  late_early_hours numeric(8, 2) not null default 0,
  base_salary numeric(12, 2) not null default 0,
  overtime_pay numeric(12, 2) not null default 0,
  allowances numeric(12, 2) not null default 0,
  holiday_pay numeric(12, 2) not null default 0,
  late_night_pay numeric(12, 2) not null default 0,
  taxable_transportation_allowance numeric(12, 2) not null default 0,
  non_taxable_transportation_allowance numeric(12, 2) not null default 0,
...
alter table public.payroll_records
  add column if not exists attendance_days numeric(8, 2) not null default 0,
  add column if not exists holiday_attendance_days numeric(8, 2) not null default 0,
  add column if not exists paid_leave_days numeric(8, 2) not null default 0,
  add column if not exists absence_days numeric(8, 2) not null default 0,
  add column if not exists late_early_count numeric(8, 2) not null default 0,
  add column if not exists scheduled_work_hours numeric(8, 2) not null default 0,
  add column if not exists overtime_work_hours numeric(8, 2) not null default 0,
  add column if not exists holiday_work_hours numeric(8, 2) not null default 0,
  add column if not exists late_night_hours numeric(8, 2) not null default 0,
  add column if not exists late_early_hours numeric(8, 2) not null default 0,
  add column if not exists holiday_pay numeric(12, 2) not null default 0,
  add column if not exists late_night_pay numeric(12, 2) not null default 0,
  add column if not exists taxable_transportation_allowance numeric(12, 2) not null default 0,
  add column if not exists non_taxable_transportation_allowance numeric(12, 2) not null default 0,
  ...
  add column if not exists nursing_care_insurance numeric(12, 2) not null default 0,
  ...
  add column if not exists child_care_support numeric(12, 2) not null default 0,
  ...
  add column if not exists social_insurance_total numeric(12, 2) not null default 0,
